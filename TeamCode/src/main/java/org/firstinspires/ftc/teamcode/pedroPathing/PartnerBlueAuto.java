...
@Configurable
@Autonomous(name = "PartnerBlueAuto", group = "Examples")
public class PartnerBlueAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(16, 112, Math.toRadians(0));
