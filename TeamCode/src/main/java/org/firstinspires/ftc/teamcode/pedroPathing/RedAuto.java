...
public class RedAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(88.080, 8.603, Math.toRadians(270));
    ...
    public void buildPaths() {
        Path1 = follower
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(88.080, 8.603),
                                new Pose(72.717, 68.415),
                                new Pose(98.936, 98.526)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(215))
